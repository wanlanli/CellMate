...
class CellNetworkPatch(CellNetwork):
    def __init__(self, image, time_network, tracker, threshold):
...
def intensity_multiple_points(image, centers, radius, mask, method="mean", percentile=50):
    """
    ...
    intensities = []
    background = np.percentile(image[mask], 50)
